...
architecture rtl of Zynq_PS7 is
	...
	component PS7 is
		port (
			...
			AXIGP0ACLK		: in  Std_Logic;
			AXIGP0ARREADY	: in  Std_Logic;
			AXIGP0AWREADY	: in  Std_Logic;
			AXIGP0BVALID	: in  Std_Logic;
			AXIGP0RLAST		: in  Std_Logic;
			AXIGP0RVALID	: in  Std_Logic;
			AXIGP0WREADY	: in  Std_Logic;
...
begin
	...
	the_PS7: PS7 port map (
		...
		AXIGP0ACLK		=> GP0_Clk,
		AXIGP0ARREADY	=> GP0_In.ArReady,
		AXIGP0AWREADY	=> GP0_In.AwReady,
		AXIGP0BVALID	=> GP0_In.BValid,
		AXIGP0RLAST		=> GP0_In.RLast,
		AXIGP0RVALID	=> GP0_In.RValid,
		AXIGP0WREADY	=> GP0_In.WReady,
